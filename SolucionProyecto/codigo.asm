...
.data
	...
	texto1 BYTE "¡Bienvenido!, este programa en ensamblador es para Arquitectura de Computadores del semestre 2019-2",0ah,0
...
main PROC
	...
	mov esi,0						;Desde aqui voy a recorrer caracter por caracter
	...
	ident:
		...
		digito:
			...
			add pos,1				;Cuantos numeros hay 
			jmp salto
		coma:
			add hola,1				;Cuantas comas hay 
